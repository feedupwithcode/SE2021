			...
			<div class="row">
				...
				<div class="col-lg-5 mx-lg-auto col-md-8 col-10">
					<h1 class="text-white" data-aos="fade-up" data-aos-delay="100">
						<strong>Safe and Secured </strong> Fund Transfer.
					</h1>
				</div>
				...
				<div class="col-lg-3 col-md-6 col-12" data-aos="fade-up"
					...
					<p class="mb-1">
						<i class="fa fa-phone mr-2 footer-icon"></i> +0123456789
					</p>
				...
				<div class="col-lg-3 col-md-6 col-12" data-aos="fade-up"
					...
					<p class="mb-1">
						<i class="fa fa-home mr-2 footer-icon"></i> Km9 Nguyen Trai, Thanh
						Xuan, Hanoi
					</p>
				</div>
